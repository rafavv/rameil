// PSS-Daten — editierbar ohne HTML-Kenntnisse
...
Verteiler: Kardiologische Fachgesellschaften in DACH, APS, GQMG, Stiftung PS CH und Plattform Patientensicherheit, BFArM, Hersteller von Kontrastmitteln.
...
Durch das Thema PSS 1 erfährt man immerhin noch, daß offenkundig versehentlich Luft statt Kontrastmittel im Rahmen einer Herzkatheteruntersuchung injiziert wurde, mit nachfolgend tödlichem Ausgang. Sieht man sich hingegen die Veröffentlichung des PSS Nr. 1 auf der Internetseite der Deutschen Gesellschaft für Patientensicherheit an, findet sich hier die Erläuterung, die dem PSS Nr. 1 auf der TK-Seite fehlt: Bei einer Herzkatheteruntersuchung wurde versehentlich Luft statt Kontrastmittel injiziert, wodurch es zu einem Herzstillstand und schließlich zum Tod kam. Ursächlich hierfür war ein fehlender technischer Schutz vor Luftinjektionen.
...
Grundsätzlich dürfen gesetzliche Krankenkassen in ihren Beiträgen zu Anwaltskanzleien verlinken, so lange dies sachlich begründet ist und nicht gegen das Wettbewerbsrecht verstößt. Die Verlinkung darf nicht irreführend sein und auch keinen unzulässigen Wettbewerbsvorteil für einen bestimmten Anwalt schaffen (§1, §3 UWG).`
  },
  {
    number: "PSS 08",
...
Link 6 führt auf die Seite Pschyrembel-online zur Definition der Braden-Skala. Wenn man mehr als die kurze Definition lesen möchte, steht für kurze Zeit eine Gratis-Version zur Verfügung – generell sind die Inhalte nur über ein kostenpflichtiges Abo verfügbar.`
  },
  {
    number: "PSS 11",
...
Bei PSS Nr. 11 funktioniert Link 1 nicht, Link 2 führt zu einem Abstract aus 2002 des British Journal of Anaesthesia und Link 3 zeigt einen Artikel von 2010 aus der Zeitschrift für Herz-, Thorax- und Gefäßchirurgie – der nur gegen ein kostenpflichtiges Abo zugänglich ist.`
  },
  {
    number: "PSS 12",
...
Link 4: WHO-Seite, World-Patient-Safety-Day 17.09.2025: „Safe care for every newborn and every child" – keinerlei Bezug zum Thema des PSS Nr. 15.`
  },
  {
    ...
    content: `Link 1: Übersichtsarbeit von 2009 im Deutschen Ärzteblatt zur „Diagnostik und Therapie hypertensiver Schwangerschaftserkrankungen" – zum Zeitpunkt der Veröffentlichung des PSS Nr. 16 ein 14 Jahre alter Artikel, den man nur vollständig lesen kann, wenn man sich registriert.

Link 2: Deutsches Ärzteblatt 2023, Artikel über ein Schwangerschaftsnachsorgeprogramm der Uni Leipzig – das PSS Nr. 16 bezieht sich auf die Sicherheit während der Schwangerschaft und nicht auf eine Nachsorge.

Link 3: Springermedizin, Die Intensivmedizin, Schwangerschaftsassoziierte Notfälle – ein Kapitel aus einem Buch für Intensivmediziner.

Link 4: Gelbe Liste, Pharmaindex – Langzeiteffekte hypertensiver Schwangerschaftserkrankungen – kein Bezug zum Thema des PSS Nr. 16.`
  },
  {
    number: "PSS 17",
...
Fall 4 – Geburtseinleitung: Keinerlei Informationen zu Geburtsjahr, Klinik, Patientin, Anzahl vorangegangener Schwangerschaften, Schwangerschaftswoche zum Zeitpunkt der Einleitung, welche Art von Diabetes vorlag. Keine Angaben zur Dauer der Einleitung und zum kindlichen Outcome.
...
Link 3 – Ärztezeitung online, kurzer Artikel von 2012 aus Oxford für dortige Hausärzte.
Link 4 – Artikel aus 2011 aus der Kinderanästhesiologie über Medikationsfehler – 15 Jahre alt zum Zeitpunkt der Veröffentlichung.
Link 5 – Deutsche Gesellschaft für Kinderchirurgie.
Link 6 – Eltern-Bildung – kurzer Artikel, der vollkommen am Zielpublikum vorbeigeht.
Link 7 – Einladung zu einem Webinar des Dresdner Universitätsklinikums Pädiatrie für den 05.07.2022 – drei Jahre vor Erscheinen des PSS Nr. 18.
Link 8 – Abstract einer pädiatrischen Studie in Australien, nicht frei zugänglich.
Link 9 – TK-eigene Seite „Welche Ursache können Bauchschmerzen im Kindesalter haben" – Informationsseite für medizinische Laien.`
  },
  {
    number: "PSS 19",
...
Link 9: Gebührenpflichtige Lernplattform Thieme via medici.`
  },
  {
    ...
    content: `Unter Bedeutung wird auf zahlreiche Fallbeispiele innerhalb der TK-Schadensfallmeldungen im Zusammenhang mit Tumorerkrankungen hingewiesen. „Viele dieser Ereignisse seien ‚klassische', vermeidbare Patientensicherheitsprobleme, die bei konsequenter Anwendung etablierter Sicherheitsmaßnahmen nicht auftreten sollten." Auf Quellenangaben und nähere Angaben zu Fallzahlen wird verzichtet.
...
Fall 1 (Keine Befundübermittlung trotz Verdacht auf Brustkrebs), Fall 2 (Implantat nach Brustkrebs-Op freiliegend), Fall 3 (Klinikum hat vergessen über Tumor zu informieren), Fall 4 (Hirntumor 3 Jahre lang nicht erkannt), Fall 5 (Deutlich verzögerte Diagnostik eines Plattenepithelkarzinoms), Fall 6 (Tumor bei kindlicher U-Untersuchung nicht erkannt) und Fall 7 (Rektum-Karzinom nicht erkannt) – alle weisen erhebliche Lücken in der Falldarstellung auf. Die Fallbeschreibung von Fall 7 endet inmitten eines Satzes, was offenkundig bislang niemandem aufgefallen ist.

Wichtige Verlinkungen/Literatur: 13 Links, darunter Kongressankündigungen, Homepages von Fachgesellschaften und Leitlinienregister – überwiegend ohne direkten inhaltlichen Bezug zu den geschilderten Fällen.`
  },
  {
    number: "PSS 22",
